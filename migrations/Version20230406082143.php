 ...
 */
final class Version20230406082143 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE parameter_value ADD COLUMN value VARCHAR(255) NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__parameter_value AS SELECT id, content_parameter_id FROM parameter_value');
        ...
        $this->addSql('INSERT INTO parameter_value (id, content_parameter_id) SELECT id, content_parameter_id FROM __temp__parameter_value');
